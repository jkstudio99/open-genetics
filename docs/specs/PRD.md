...
- **Acceptance Criteria**:
  - `php add/genetics mutate` — สร้างตาราง + seed
  - `php add/genetics serve` — dev server
  - `php add/genetics make:endpoint <name>` — scaffold endpoint
  - `php add/genetics make:middleware <name>` — scaffold middleware
  - `php add/genetics new <name>` — สร้าง project ใหม่
  - `php add/genetics status` — ตรวจสอบ DB connection
