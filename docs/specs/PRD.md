...
- **Acceptance Criteria**:
  - `php genetics mutate` — สร้างตาราง + seed
  - `php genetics serve` — dev server
  - `php genetics make:endpoint <name>` — scaffold endpoint
  - `php genetics make:middleware <name>` — scaffold middleware
  - `php genetics new <name>` — สร้าง project ใหม่
  - `php genetics status` — ตรวจสอบ DB connection
