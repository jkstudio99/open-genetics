...
PAGES = [
    ...
    ('query-builder',      'Query Builder',        'Query Builder',       'ds.query_builder'),
...
GROUPS = {
    ...
    'api-reference': 'api-ref', 'database': 'api-ref', 'query-builder': 'api-ref', 'migrations': 'api-ref', 'response': 'api-ref',
...
SEARCH_ICONS = {
    ...
    'api-reference': 'code',
    'database': 'db', 'query-builder': 'db', 'migrations': 'db', 'response': 'out', 'guard': 'shield',
