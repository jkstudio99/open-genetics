...
.doc-content h4{font-size:15px;font-weight:600;color:#cbd5e1;margin-top:36px;margin-bottom:12px}
...
[data-theme="light"] .doc-content h3{color:#334155!important}
...
[data-theme="light"] .ft-desc{color:#64748b!important}
...
<div style="margin-top:80px;padding:0 0 32px;max-width:820px;margin-left:auto;margin-right:auto">
  <div class="footer-card" style="background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.06);border-radius:24px;padding:44px 48px;display:flex;align-items:center;gap:40px;flex-wrap:wrap;justify-content:space-between">
    <div style="flex:1;min-width:260px">
      ...
      <a href="https://github.com/jkstudio99/open-genetics" target="_blank" style="display:inline-flex;align-items:center;gap:8px;padding:10px 18px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);border-radius:12px;color:#e2e8f0;font-size:14px;font-weight:600;text-decoration:none;transition:all 200ms" onmouseover="this.style.background='rgba(255,255,255,.1)';this.style.borderColor='rgba(255,255,255,.2)'" onmouseout="this.style.background='rgba(255,255,255,.05)';this.style.borderColor='rgba(255,255,255,.1)'">
