...
(function () {
  ...
  const dict = {
    ...
    // ── Hero ──
    'hero.subtitle':      { th: 'เฟรมเวิร์ค PHP ที่มาพร้อม JWT Auth, RBAC, i18n และ Genetic SDK ให้คุณสร้าง REST API ที่ปลอดภัย เร็ว และขยายได้ — บน XAMPP',
    ...
    'feat.speed.desc':    { th: 'Micro-framework ที่เบาที่สุด — ไม่มี ORM overhead, ใช้ PDO Singleton และ File-based Routing ตอบสนองใต้ 50 มิลลิวินาที',
    ...
    'feat.jwt.desc':      { th: 'ระบบยืนยันตัวตน HS256 ในตัว พร้อม Bcrypt 12 รอบ รองรับทั้ง firebase/php-jwt และ native PHP fallback',
    ...
    'feat.rbac.desc':     { th: 'Guard ควบคุมสิทธิ์ Admin, HR, Employee ในระดับ DNA ของทุก API request — เพียงบรรทัดเดียว',
    ...
    'feat.i18n.desc':     { th: 'รองรับ Thai/English ด้วย JSON dictionaries สลับภาษาผ่าน HTTP Header แบบ real-time ไม่ต้องรีโหลด',
    ...
    'feat.sdk.desc':      { th: 'SDK สำเร็จรูปสำหรับ Vanilla JS และ React Hook — Login, i18n, Theme Switching ด้วยโค้ดบรรทัดเดียว',
    ...
    'feat.audit.desc':    { th: 'บันทึก Log กิจกรรมอัตโนมัติ CREATE/UPDATE/DELETE แบบ Non-blocking — ไม่กระทบประสิทธิภาพ',
    ...
    'feat.route.desc':    { th: 'แต่ละไฟล์ .php ใน api/ คือ 1 endpoint — ไม่ต้องประกาศ route ง่ายเหมือนสร้างไฟล์',
    ...
    'feat.cli.desc':      { th: 'คำสั่ง php genetics mutate สร้างตาราง, Seed RBAC, และ Admin user อัตโนมัติ',
    ...
    'feat.psr4.desc':     { th: 'โครงสร้าง Namespace ตามมาตรฐาน PSR-4 ใช้ร่วมกับ Composer autoloader ได้ทันที',
    ...
    'doc.lead':           { th: 'Enterprise PHP Micro-Framework — JWT Auth, Genetic RBAC, i18n, Audit Trail, Dual-Frontend SDK. ออกแบบมาเพื่อความเร็ว (<50ms), ความปลอดภัย (OWASP), และประสบการณ์นักพัฒนาที่ดี',
    ...
    'doc.philosophy':     { th: 'ปรัชญา: เล็ก เบา ทรงพลัง — ทุก byte และ millisecond มีค่า',
